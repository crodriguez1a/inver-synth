...
def standard_run_parser()->argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Setup and train a model, storing the output')
    parser.add_argument('--model', dest='model_name',type=str,required=True,
                    choices=['C1','C2','C3','C4','C5','C6','C6XL','e2e'],default='e2e',
    ...
    parser.add_argument('--dataset_dir', default='test_datasets',
